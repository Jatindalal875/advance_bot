...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text="""  I'm *👀 AVA 👀*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n_Ava's licensed under the GNU General Public License v3.0_
                 Here is the [Contact My Owner](https://t.me/Hunter_is_back).
                 If you have any question about Ava, let us know at @Tbh_council_support.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
